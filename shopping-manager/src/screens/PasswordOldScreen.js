        ...
        <View style={styles.container}>
          <ScrollView style={{ flex: 1 }}>
            <View style={styles.screen}>
              ...
              <TouchableOpacity activeOpacity={0.6} disabled={disabled} onPress={() => navigation.navigate('ChangePassword',pwd)} style={{ ...styles.acceptContainer, backgroundColor: backgroundColor }}>
