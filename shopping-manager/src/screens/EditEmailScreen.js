...
const EditEmailScreen = ({ route, navigation , auth}) => {
  return (
          ...
          <ScrollView style={{ flex: 1 }}>
            <View style={styles.screen}>
              ...
              <View style={styles.editContainer}>
                <TextInput editable={false}   placeholderTextColor={`rgb(${Colors.text.secondary})`} value={auth.user.email} style={styles.inputEdit} placeholder={'Tên'}/>
              </View>
            </View>
          </ScrollView>
        </View>
...
export default connect(mapStateToProps)(EditEmailScreen);
