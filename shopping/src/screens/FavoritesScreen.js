...
import { getFavoriteProducts } from '../redux/favorite-product/action'
...
const FavoritesScreen = (props) => {
  ...
  useEffect(() => {
    if (favorite.items.length < 1) { dispatch(getFavoriteProducts(auth.user.id)) }
  }, []);
      ...
      <SafeAreaView>
        <TouchableWithoutFeedback accessible={false}>
          <View style={styles.container}>
            ...
            <Text style={styles.titleHeader}>Ưa thích</Text>
          </View>
